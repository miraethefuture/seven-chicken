...
insert into menutable values('세븐레드오리지날', 0,  17000);
...
insert into menutable values('세븐시그니처세트', 0,  27500);
...
insert into menutable values('한라산맥주', 0, 11000);
insert into menutable values('허니스파클링', 0,3000);
insert into menutable values('생맥주', 0, 7000);
